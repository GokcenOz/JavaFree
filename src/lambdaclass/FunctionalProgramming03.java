...
public class FunctionalProgramming03 {
    public static void main(String[] args) {
        ...
        System.out.println();
        printDistincSortedByLastCharacter(l);
        System.out.println();
    ...
    //1)Create a method print all list elements in uppercase
    //1.Way
    ...
    public static void printDistincSortedByLastCharacter(List<String> l) {
...
//    public static void removeIfLengthGraterThan5(List<String> l) {
...
//        System.out.println(l);
//	}
    //7) Create a method which takes the square of the length of every element, prints them distinctly in reverse order (edited)
